...
usd_normalized_price_return=hist['Close'][-1]/hist['Close'][0]
usd_normalized_total_return=usd_normalized_price_return*dividend_return

usd_normalized_annualized_price_return=usd_normalized_price_return**(1/years)
usd_normalized_annualized_total_return=usd_normalized_annualized_price_return*annualized_dividend_return


print("\n")
print("USD Normalized Total Price return: ", usd_normalized_price_return)
print("USD Normalized Total Dividend return: ", dividend_return)
print("USD Normalized Total return: ", usd_normalized_total_return)
print("\n")
print("USD Normalized Annualized Price return: %",usd_normalized_annualized_price_return*100-100)
print("USD Normalized Annualized Dividend return: % ", annualized_dividend_return*100-100)
print("USD Normalized Annualized Total return: %", usd_normalized_annualized_total_return*100-100)
